 ...
 * @method self audio_file_id(string $value) A valid file identifier for the audio file
...
class InlineQueryResultCachedAudio
{
     ...
     * @param string|null $audio_file_id A valid file identifier for the audio file
     ...
     */
    public static function make(string $type = null, string $id = null, string $audio_file_id = null, string $caption = null, string $parse_mode = null, array $caption_entities = null, InlineKeyboardMarkup $reply_markup = null, InputMessageContent $input_message_content = null): self
    {
