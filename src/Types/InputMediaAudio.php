 ...
 * @method self caption(string $value) <em>Optional</em>. Caption of the audio to be sent, 0-1024 characters after entities parsing
 ...
 * @method self duration(int $value) <em>Optional</em>. Duration of the audio in seconds
 * @method self performer(string $value) <em>Optional</em>. Performer of the audio
 * @method self title(string $value) <em>Optional</em>. Title of the audio
 */
class InputMediaAudio
{
     ...
     * @param string|null $caption <em>Optional</em>. Caption of the audio to be sent, 0-1024 characters after entities parsing
     ...
     * @param int|null $duration <em>Optional</em>. Duration of the audio in seconds
     * @param string|null $performer <em>Optional</em>. Performer of the audio
     * @param string|null $title <em>Optional</em>. Title of the audio
     */
    public static function make(string $type = null, string $media = null, string $thumbnail = null, string $caption = null, string $parse_mode = null, array $caption_entities = null, int $duration = null, string $performer = null, string $title = null): self
    {
