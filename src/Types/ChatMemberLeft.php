 ...
 * @method self status(string $value) The member&#39;s status in the chat, always “left”
...
class ChatMemberLeft
{
    ...
    /**
     * Represents a <a href="https://core.telegram.org/bots/api#chatmember">chat member</a> that isn&#39;t currently a member of the chat, but may join it themselves.
     * @param string|null $status The member&#39;s status in the chat, always “left”
     * @param User|null $user Information about the user
     */
    public static function make(string $status = null, User $user = null): self
    {
