 ...
 * @method self photo_file_id(string $value) A valid file identifier of the photo
...
class InlineQueryResultCachedPhoto
{
     ...
     * @param string|null $photo_file_id A valid file identifier of the photo
     ...
     */
    public static function make(string $type = null, string $id = null, string $photo_file_id = null, string $title = null, string $description = null, string $caption = null, string $parse_mode = null, array $caption_entities = null, bool $show_caption_above_media = null, InlineKeyboardMarkup $reply_markup = null, InputMessageContent $input_message_content = null): self
    {
