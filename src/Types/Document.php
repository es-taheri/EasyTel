 ...
 * @method self thumbnail(PhotoSize $value) <em>Optional</em>. Document thumbnail as defined by the sender
...
class Document
{
     ...
     * @param PhotoSize|null $thumbnail <em>Optional</em>. Document thumbnail as defined by the sender
     ...
     */
    public static function make(string $file_id = null, string $file_unique_id = null, PhotoSize $thumbnail = null, string $file_name = null, string $mime_type = null, int $file_size = null): self
    {
