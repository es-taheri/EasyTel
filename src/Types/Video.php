 ...
 * @method self cover(array $value) <em>Optional</em>. Available sizes of the cover of the video in the message
 * @method self start_timestamp(int $value) <em>Optional</em>. Timestamp in seconds from which the video will play in the message
 * @method self qualities(array $value) <em>Optional</em>. List of available qualities of the video
...
class Video
{
     ...
     * @param array|null $cover <em>Optional</em>. Available sizes of the cover of the video in the message
     * @param int|null $start_timestamp <em>Optional</em>. Timestamp in seconds from which the video will play in the message
     * @param array|null $qualities <em>Optional</em>. List of available qualities of the video
     ...
     */
    public static function make(string $file_id = null, string $file_unique_id = null, int $width = null, int $height = null, int $duration = null, PhotoSize $thumbnail = null, array $cover = null, int $start_timestamp = null, array $qualities = null, string $file_name = null, string $mime_type = null, int $file_size = null): self
    {
