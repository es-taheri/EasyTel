 ...
 * @method self comment(string $value) <em>Optional</em>. Comment with which the post was declined
 */
class SuggestedPostDeclined
{
     ...
     * @param string|null $comment <em>Optional</em>. Comment with which the post was declined
     */
    public static function make(Message $suggested_post_message = null, string $comment = null): self
    {
