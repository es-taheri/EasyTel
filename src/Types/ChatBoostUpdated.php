 ...
 * @method self boost(ChatBoost $value) Information about the chat boost
 */
class ChatBoostUpdated
{
     ...
     * @param ChatBoost|null $boost Information about the chat boost
     */
    public static function make(Chat $chat = null, ChatBoost $boost = null): self
    {
