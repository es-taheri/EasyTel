 ...
 * @method self document_file_id(string $value) A valid file identifier for the file
...
class InlineQueryResultCachedDocument
{
     ...
     * @param string|null $document_file_id A valid file identifier for the file
     ...
     */
    public static function make(string $type = null, string $id = null, string $title = null, string $document_file_id = null, string $description = null, string $caption = null, string $parse_mode = null, array $caption_entities = null, InlineKeyboardMarkup $reply_markup = null, InputMessageContent $input_message_content = null): self
    {
