 ...
 * @method self type(string $value) Type of the result, must be <em>animation</em>
 ...
 * @method self caption(string $value) <em>Optional</em>. Caption of the animation to be sent, 0-1024 characters after entities parsing
 * @method self parse_mode(string $value) <em>Optional</em>. Mode for parsing entities in the animation caption. See <a href="https://core.telegram.org/bots/api#formatting-options">formatting options</a> for more details.
 ...
 * @method self width(int $value) <em>Optional</em>. Animation width
 * @method self height(int $value) <em>Optional</em>. Animation height
 * @method self duration(int $value) <em>Optional</em>. Animation duration in seconds
 * @method self has_spoiler(bool $value) <em>Optional</em>. Pass <em>True</em> if the animation needs to be covered with a spoiler animation
 */
class InputMediaAnimation
{
    ...
    /**
     * Represents an animation file (GIF or H.264/MPEG-4 AVC video without sound) to be sent.
     * @param string|null $type Type of the result, must be <em>animation</em>
     ...
     * @param string|null $caption <em>Optional</em>. Caption of the animation to be sent, 0-1024 characters after entities parsing
     * @param string|null $parse_mode <em>Optional</em>. Mode for parsing entities in the animation caption. See <a href="https://core.telegram.org/bots/api#formatting-options">formatting options</a> for more details.
     ...
     * @param int|null $width <em>Optional</em>. Animation width
     * @param int|null $height <em>Optional</em>. Animation height
     * @param int|null $duration <em>Optional</em>. Animation duration in seconds
     * @param bool|null $has_spoiler <em>Optional</em>. Pass <em>True</em> if the animation needs to be covered with a spoiler animation
     */
    public static function make(string $type = null, string $media = null, string $thumbnail = null, string $caption = null, string $parse_mode = null, array $caption_entities = null, bool $show_caption_above_media = null, int $width = null, int $height = null, int $duration = null, bool $has_spoiler = null): self
    {
