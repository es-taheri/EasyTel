 ...
 * @method self voice_file_id(string $value) A valid file identifier for the voice message
 * @method self title(string $value) Voice message title
 ...
 * @method self input_message_content(InputMessageContent $value) <em>Optional</em>. Content of the message to be sent instead of the voice message
 */
class InlineQueryResultCachedVoice
{
     ...
     * @param string|null $voice_file_id A valid file identifier for the voice message
     * @param string|null $title Voice message title
     ...
     * @param InputMessageContent|null $input_message_content <em>Optional</em>. Content of the message to be sent instead of the voice message
     */
    public static function make(string $type = null, string $id = null, string $voice_file_id = null, string $title = null, string $caption = null, string $parse_mode = null, array $caption_entities = null, InlineKeyboardMarkup $reply_markup = null, InputMessageContent $input_message_content = null): self
    {
