 ...
 * @method self video_file_id(string $value) A valid file identifier for the video file
 ...
 * @method self input_message_content(InputMessageContent $value) <em>Optional</em>. Content of the message to be sent instead of the video
 */
class InlineQueryResultCachedVideo
{
     ...
     * @param string|null $video_file_id A valid file identifier for the video file
     ...
     * @param InputMessageContent|null $input_message_content <em>Optional</em>. Content of the message to be sent instead of the video
     */
    public static function make(string $type = null, string $id = null, string $video_file_id = null, string $title = null, string $description = null, string $caption = null, string $parse_mode = null, array $caption_entities = null, bool $show_caption_above_media = null, InlineKeyboardMarkup $reply_markup = null, InputMessageContent $input_message_content = null): self
    {
