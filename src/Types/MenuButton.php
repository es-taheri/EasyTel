...
class MenuButton
{
    ...
    public static function make(MenuButtonCommands $menubuttoncommands=null, MenuButtonWebApp $menubuttonwebapp=null, MenuButtonDefault $menubuttondefault=null): self
    {
